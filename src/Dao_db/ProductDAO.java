...
public class ProductDAO implements AutoCloseable {
    ...
    public void addProduct(Product product) throws SQLException {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            if (affectedRows == 0) {
                throw new SQLException("Создание товара не удалось, ни одна запись не была изменена.");
            }
    ...
    public List<Object[]> getAllProducts() throws SQLException {
        ...
        String sql = "SELECT p.product_id, p.name, p.description, p.quantity, p.price, " +
